...
SITE_IDENTIFIER = 'anime'  # identifant (nom de votre fichier) remplacez les espaces et les . par _ AUCUN CARACTERE SPECIAL
SITE_NAME = 'anime_sama'  # nom que KODI affiche
SITE_DESC = 'animes japonnais' # description courte de votre source

URL_MAIN = 'https://anime-sama.fr/'  # url de la source
